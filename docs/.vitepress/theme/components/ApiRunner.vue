...
const labels: Record<string, string> = {
  ...
  detectBot: 'Run bot heuristics',
  detectSpoofing: 'Run spoofing heuristics',
  detectAntiDetect: 'Run anti-detect heuristics',
  detectNoise: 'Run noise detection',
  detectIncognito: 'Run incognito detection',
  environment: 'Detect environment',
  benchmark: 'Run benchmark',
  attestDevice: 'Run risk scoring (high strictness)',
